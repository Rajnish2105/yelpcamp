...
const seedDB = async () => {
  ...
  for (let i = 0; i < 50; i++) {
    ...
    const camp = new Campground({
      ...
      description:
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit ipsa delectus praesentium aperiam vel, ipsam ut blanditiis commodi aliquid. Aut aliquid cum consectetur nihil necessitatibus neque corporis et ipsam nostrum?",
      price,
    });
    await camp.save();
  }
